...
({
	...
	@NamedQuery(name = "ScheduleEntity.findIfClassroomExist", query = "SELECT u.classroom FROM ScheduleEntity u WHERE u.classroom = :classroom AND ((u.dayStart>=:dayStart AND u.dayStart<=:dayEnd) OR (u.dayEnd>=:dayStart AND u.dayEnd<=:dayEnd))")
})
